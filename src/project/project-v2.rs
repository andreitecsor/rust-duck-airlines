...
impl Segment {
    ...
    fn new(start: Waypoint, end: Waypoint) -> Self { //Self can be replaced with Segment
        Self {
            start,
            end,
        }
    ...
    fn distance(&self) -> f32 {
        //&self gives access to internal data of the struct
...
fn main() {
    ...
    let kslc = Waypoint {
        ...
        latitude: 40.7861,
        longitude: -111.9822,
        // ..kcle //autocompletes the other fields with the structure provided
    };
